...
public class TwitterAccount{
	...
	public ArrayList<TwitterAccount> getFollowers(Comparator<TwitterAccount> a){
		if(a == null) {
			throw new IllegalArgumentException();
		}
		
		ArrayList<TwitterAccount> temp = new ArrayList<TwitterAccount>(followers);
		Collections.sort(temp, new FollowersCountComparator());
		return temp;
